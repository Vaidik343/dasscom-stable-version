...
export default function Controls() {
  ...
  return (
    <>
      <div className="controls d-flex p-2 mx-4 gap-4 align-items-center">
        ...
        <button onClick={async () => {
          try {
            ...
            if (err.message.includes('No suitable network interfaces')) {
              alert("⚠️ Local network not found. Please connect to a Wi-Fi or plug in an Ethernet cable to scan for local devices.");
            } else {
              alert("❌ Scan error: " + err.message);
            }
          }
        }} disabled={scanning} className="btn btn-primary d-flex align-items-center gap-2">
          {scanning ? (
            <>
        ...
        <div className="discovery-stats d-flex flex-wrap gap-2 ms-auto align-items-center">
          {/* Total Badge */}
          <div className="badge rounded-pill bg-secondary-subtle text-secondary-emphasis border border-secondary-subtle px-3 py-2 d-flex align-items-center" style={{ fontSize: "0.80rem" }}>
            <svg width="10" height="10" className="me-2" viewBox="0 0 16 16" fill="currentColor">
          ...
          {/* Online Badge */}
          <div className="badge rounded-pill bg-success-subtle text-success-emphasis border border-success-subtle px-3 py-2 d-flex align-items-center" style={{ fontSize: "0.80rem" }}>
            <svg width="14" height="14" className="me-2" viewBox="0 0 16 16" fill="currentColor">
          ...
          {/* Offline Badge */}
          <div className="badge rounded-pill bg-danger-subtle text-danger-emphasis border border-danger-subtle px-3 py-2 d-flex align-items-center" style={{ fontSize: "0.80rem" }}>
            <svg width="14" height="14" className="me-2" viewBox="0 0 16 16" fill="currentColor">
